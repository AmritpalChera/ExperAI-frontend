  ...
  return (
    <div className="flex w-full flex-col justify-center items-center">
      ...
      <div className=' w-full flex justify-center mx-2 mt-12'>
          ...
          <input autoFocus className='bg-white text-black cursor-text mx-2 rounded-3xl py-3 px-4 max-w-4xl w-full border-2 shadow-lg shadow-gray' placeholder={`https//medium.com/...`}></input>
      </div>
